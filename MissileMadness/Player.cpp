...
void Player::Update()
{
	...
	{
		glm::quat rot = glm::angleAxis(-rotateSpeed * Time::deltaTime, glm::vec3(0.0f, 0.0f, 1.0f));
	...
	if (InputManager::Instance().GetKey(GLFW_KEY_W) || InputManager::Instance().GetKey(GLFW_KEY_UP))
		transform.Translate(transform.GetUp() * Time::deltaTime * maxSpeed);
...
void Player::ShootProjectile()
{
	...
	// Pew pew
	Debug::LogFormat("Pew pew, DeltaTime: %2.6f", Time::deltaTime);
